...
public class ModifPostController implements Initializable {
    ...
    ModifPostController(int selectedPostId) {
this.postId=selectedPostId;
  ...
  try {
    ...
    if (text_titre.getText().isEmpty() || text_contenu.getText().isEmpty() || text_id_user.getText().isEmpty() || text_like.getText().isEmpty() || text_dislike.getText().isEmpty()) {
    ...
    Post post = new Post(postId, titre, contenu, LocalDateTime.now(), id_user, like, dislike);
    ...
    try {
        ...
        crudPost.modifierPost(post, postId);
